...
export default function AwsEC2Icon(props: React.SVGProps<SVGSVGElement>) {
  return (
    // <div className="bg-white border border-gray-100 rounded-full p-1 w-[25px] h-[20px]">
    <div className="rounded-full p-1 flex items-center justify-center">
      <svg
        ...
        {...props}
      >
        <title>AWS EC2 - Amazon Elastic Compute Cloud</title>
        <g
